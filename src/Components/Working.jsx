...
let working =()=>{
    return(
        <div className="footer">
            <p className="title">How <span className="title_name">CarLink</span>  Works</p>
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 6 6 0 0 1 3.13-1.567"/>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-backpack2" viewBox="0 0 16 16" className="trip_logo">
